    ...
    try {
      ...
      for (const event of events) {
         ...
         if (matchChatId && matchChatId[1]) {
            ...
            const msg = `Hej ${name}! Det här är en påminnelse från Laser Luxury. Du har en bokad tid för behandling imorgon, ${dayName} den ${dayNum} ${monthName}, klockan ${tStr}. Vi ser fram emot att träffa dig! Varmt välkommen! 😊`;
