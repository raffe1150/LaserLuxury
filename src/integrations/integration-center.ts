...
export const INTEGRATION_PROVIDERS: readonly IntegrationProviderDefinition[] = [
  {
    ...
    destinationLabel: 'Open Google Calendar',
    destinationUrl: 'https://calendar.google.com/',
    startTitle: 'Connect your Google Calendar',
    startCopy: 'Sign in with Google and authorize OdinLink to access your writable calendars.',
    startVisual: {
      type: 'illustration',
      path: ['OdinLink', 'Google sign-in', 'Calendar access'],
      targetIndex: 2,
    },
